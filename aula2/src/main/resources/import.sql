...
insert into produto (nome, descricao, valor, categoria_id, data_fabricacao) values ('Monitor 27pol','Monitor Gamer 27pol 144Hz, 1ms',1129.99,1,'2020-02-13');
insert into produto (nome, descricao, valor, categoria_id, data_fabricacao) values ('Kit Teclado e Mouse','Kit com teclado ABNT e mouse com 5 botões',199.0,1,'2020-02-15');