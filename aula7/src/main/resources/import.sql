...
insert into produto (nome, descricao, valor, categoria_id, marca_id) values ('Produto 5','Descrição detalhada do produto...',1990.0,2,1);
insert into produto (nome, descricao, valor, categoria_id, marca_id) values ('Produto 6','Descrição detalhada do produto...',2449.0,1,3);
insert into produto (nome, descricao, valor, categoria_id, marca_id) values ('Produto 7','Descrição detalhada do produto...',1129.99,1,2);
insert into produto (nome, descricao, valor, categoria_id, marca_id) values ('Produto 8','Descrição detalhada do produto...',199.0,1,1);
